...
{
    /// <inheritdoc />
    public partial class init172 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeacherId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AnnouncementType = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoursesCourseId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Submissions_Courses_CoursesCourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_CoursesCourseId",
                table: "Submissions",
